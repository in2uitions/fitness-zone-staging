    ...
    return (
        ...
        >
            <div className="">
                ...
                <div className="row mobileRow">
                    {
                        data.personal_training_components?.map((service, index) => (
                            <div className={`contact_block ptsection col-lg-4 cursor-pointer`} key={service.membership_components_id.id}>
                                <div style={{ position: "relative" }} className={` wow fadeInUp `} data-wow-delay={service.membership_components_id.id === 1 ? ".5s" : service.membership_components_id.id === 2 ? ".3s" : ".8s"}>
                                    <div>
                                        <img
                ...
                <Popup trigger={
                    // <div className="booksession cursor-pointer" style={{ display: "flex", justifyContent: "center", background: "#0090DF", padding: "10px 20px" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "center", width: "100%" }}>
                            <div className="rounded-md" style={{
                                ...
                                <a style={{
                                    display: "flex",
                                    justifyContent: "center"
                                }} className=" cursor-pointer">{data.book_session_button}</a>
                            </div>
                        </div>
                } modal nested
