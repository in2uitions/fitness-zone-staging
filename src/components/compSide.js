...
export default function CompSide({ data = {}, isFlipped = false, style = 'white' }) {
    ...
    return (
        <>
            ...
            {data.image_position == "left" ? <div className="about section-padding" style={{ backgroundImage: 'url("MainSiteImg.png")', backgroundRepeat: "no-repeat" }}>
                <div className="container" >
                    ...
                    {!data.free_trial ? <div className="row"><div className="col-lg-6">
                        <div className="img-mons">
                            <div className="row">
                                <img src={`${image_url}${data.image?.id}`} alt={`${data.image?.title}`} />
                            </div>
