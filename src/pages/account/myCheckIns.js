            ...
            <section style={{marginBottom:"2rem"}}>
                <div className='flex flex-col justify-center mt-40 ' id="btnScrollToTop">
                    <div className='flex flex-col mx-auto justify-start items-start lg:w-1/3 md:w-1/3 w-full lg:px-0 md:px-0 px-3'>
                        <p className='text-[#008DDC] font-bold mb-3'>My Recent Check-ins</p>
                        {slice.map((item) => (
                            <>
                                <div className='flex justify-start items-start classes-box mb-3 p-3' >
                                    <div className='space-x-2 flex w-full'>
                                        ...
                                        className='text-white lg:text-md md:text-md pr-2 border-r border-[#008DDC] futura-book w-2/5 flex justify-center items-center checkins-labels'>{moment(item.value).format("DD MMM YYYY")}</p>
                                        <p 
                                        style={{borderRight:"1px solid white"}}
                                        className='text-white lg:text-md md:text-md pr-2 border-r border-[#008DDC] futura-book w-2/5 flex justify-center items-center checkins-labels'>{moment(item.value).format("HH:mm")}</p>
