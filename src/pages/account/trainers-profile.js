        ...
        <>
            ...
            <section style={{marginBottom: "2rem"}}>
                ...
                <div className="flex justify-between">
                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:gap-x-10 lg:gap-y-3 items-start mt-10 space-y-10 lg:space-y-0 md:space-y-0" style={{gap:"10px"}}>
                        {/* {data.map((item) => ( */}
                            ...
                            <div className='flex flex-col space-y-3 membership-box p-10 items-center'>
                                <>
                                    ...
                                    <div className="flex space-x-3 items-center rounded-md p-2 active-button">
                                        <img className="" src="/homepage/location-marker.png" style={{
                                            width:"1rem"
                                        }}/>
                        ...
                        <div className="col-span-4">
                        <p className="text-[#008DDC] font-bold mb-4">Qualifications</p>
                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:gap-x-10 gap-y-5 lg:space-y-0 md:space-y-0" style={{rowGap:"1.25rem", gap:"1.25rem", marginTop:"1.25rem"}}>
