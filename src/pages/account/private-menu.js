    ...
    return ( 
        <div className={styles.container}>
            <nav className={colorChange ? styles.navWithBg : styles.nav}>
                <a href="/">
                    <img src="/logo.svg" className="logo" style={{width:"60%"}} />
                </a>
                <Popup
                    trigger={
                        <div className="flex items-center space-x-2">
                            ...
                            {/* <p className="font-bold text-white montserrat-book cursor-pointer">
                                Menu
                            </p> */}
                        </div>
                    }
                ...
                >
                    <div className="popuptop w-screen h-screen flex flex-col justify-center items-center popup-overlay">
                        ...
                        style={{border:"4px solid #008DDC", display:"flex"}}>
                            ...
                            <p className="font-bold text-6xl text-colorblue">{data.lastName?.charAt(0)}</p>
                        </a>
                        <p className="font-bold text-colorblue montserrat-bold" style={{marginTop:"1.25rem", fontSize:"18px"}}>{data.fullName}</p>
                        <div className="flex flex-col " style={{marginTop:"2.5rem"}}>
                            <div className="lg:space-x-3  lg:space-y-0 md:space-y-0 mobile-flex-col" style={{display:"flex"}}>
                                <a
                                    ...
                                    className="montserrat-book menu-member flex items-center justify-between rounded-md"
                                ...
                                <a href='/account/membership' className="montserrat-book menu-member flex items-center justify-between rounded-md"
                                style={{display:"flex"}}>
                                    Membership Settings
                                    <ChevronRightIcon className="forward-blue" />
                                </a>
                            ...
                            <div className="mobile-flex-col margin0" style={{display:"flex", marginTop:"1.25rem"}}>
                                <a href="/account/classListing" className="montserrat-book menu-member  items-center justify-between text-white rounded-md"
                                 style={{marginRight:"10px", display:"flex"}}>
                                    Classes / Book a class
                                    <ChevronRightIcon className="forward-blue" />
                                </a>
                                <a href='/account/trainers' className="montserrat-book menu-member  items-center justify-between rounded-md"
                                style={{display:"flex"}}>
                            ...
                            <form onSubmit={onSubmitForm}>
                                <div className="flex justify-center items-center">
                                    <button type="submit" className="logOUT text-white border-2 bg-transparent w-1/2 p-2 montserrat-book rounded-md logouts" style={{border:"2px solid #008DDC",marginTop:"2.5rem"}}>Log Out</button>
                                </div>
                            </form>
                        </div>
                    </div>
