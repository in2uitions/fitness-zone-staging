                            ...
                            <div className='' >
                                {selected === i && (
                                    <div className="absolute bottom-2 left-16 right-16" >
                                        ...
                                        <a href={`#${item.comp_accordion_items_id?.value}`} key={i} onClick={() => { setShow(true) }} className="futura-bold">{item.comp_accordion_items_id?.button_title}<ChevronRightIcon /></a>
                                    </div>
                                )}
                            </div>
